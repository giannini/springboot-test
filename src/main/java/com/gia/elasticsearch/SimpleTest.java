...
/**
 * Created by Fenglin on 2017/5/23.
 */
public class SimpleTest {

    private static final String index = "bookstore";
...
//        searchAll(client);
    ...
    private static void doIndex(final Client client) {
        ...
        BulkResponse bulkResponse = client
                ...
                .add(client.prepareIndex(index, type).setId("221").setSource(s22).setOpType(IndexRequest.OpType.INDEX).request())
                .execute().actionGet();
